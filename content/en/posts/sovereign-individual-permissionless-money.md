...
Bitcoin was the proof of concept. But for permissionless money to reach everyday people, further evolution was needed. The Liquid Network is one such evolution.

The Liquid Network is a Bitcoin sidechain that adds important capabilities: faster transactions, lower fees, and crucially, Confidential Transactions. On the main Bitcoin network, anyone can see the amounts being transferred. On Liquid, amounts are cryptographically hidden — only the sender and receiver know how much was moved.

DePix exists within this environment. It is a stablecoin on the Liquid Network where 1 DePix equals 1 Brazilian real. This solves a practical problem: most people do not want daily exposure to Bitcoin's price volatility. They want a way to hold digital currency with the properties of permissionless money — no intermediaries, with privacy, under their own control — but denominated in a familiar unit of value.
...
Just as you lock your front door without hiding anything, you may want your finances to have a level of [privacy](/en/posts/financial-privacy-depix/) that the banking system simply does not provide. Just as you keep an emergency fund at home or diversify your investments, you may want part of your wealth to exist in a format that does not depend on the goodwill of third parties.
...
The difference between [DePix and traditional Pix](/en/posts/depix-vs-traditional-pix/) is not that one is good and the other is bad. Both have their place. But having access to both options is what defines financial freedom.
...
Being a sovereign individual does not require abandoning the traditional financial system — it only requires having alternatives. Pix has convenience — DePix has privacy. Stop exposing every transaction to the banking system and start using digital money that only you control. Visit [depixapp.com](https://depixapp.com/).
