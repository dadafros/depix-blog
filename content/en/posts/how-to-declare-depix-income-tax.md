...
<div class="d-flow-row">
  <div class="d-step dark">Assets and Rights</div>
  <div class="d-arrow">→</div>
  <div class="d-step accent">Group 08: Crypto Assets</div>
  <div class="d-arrow">→</div>
  <div class="d-step success">Code 03: Stablecoins</div>
</div>
{{< /diagram >}}
...
5. **Pay the DARF** by the last business day of the month following the transaction.
6. **At annual filing time**, import the GCAP data into IRPF under "Ganhos de Capital > Importação GCAP".
...
Declaring taxes is a legal obligation — but that does not mean the banking system needs to see every transaction you make. With DePix, your transactions on the Liquid Network use Confidential Transactions, keeping your amounts private from prying eyes. Fulfill your tax obligations while maintaining your financial privacy — the best of both worlds. Visit [depixapp.com](https://depixapp.com/).
