...
There is. The [DePix App](https://depixapp.com/) offers a merchant mode that lets you accept Pix payments from any customer and receive the funds as [DePix — a BRL-pegged stablecoin](/en/posts/what-is-depix/) — directly in your own Liquid wallet. No business registration, no KYC documents, no bank account required. Just an email address and one minute of your time.
...
| Payment method | Fee range | Extra costs |
|---|---|---|
| **DePix App** | 2% + R$0.99 | None |
| **Debit card** | 0.59% - 1.99% | Hardware rental, monthly fees |
...
This flexibility is what sets DePix apart from [traditional Pix transfers](/en/posts/depix-vs-traditional-pix/). With regular Pix, your money is trapped in the banking system. With DePix, you choose where it goes and what it becomes.
...
This is not a limitation; it is a feature. Read the full explanation in our post on [how DePix protects against scams](/en/posts/how-depix-protects-against-scams/).
...
Pix has convenience — DePix has privacy. Stop exposing every transaction to the banking system and start using digital money that only you control. Open your crypto business account in minutes and leave the banking bureaucracy behind. Visit [depixapp.com](https://depixapp.com/).
