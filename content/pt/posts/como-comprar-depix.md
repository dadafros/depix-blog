...
Antes de começar, tenha estes três itens prontos:

1. **Uma conta bancária com Pix** — qualquer banco ou fintech serve (Nubank, Inter, Itaú, Bradesco, etc.).
2. **Uma carteira Liquid** — o DePix App é não-custodial, então você precisa de uma carteira externa para receber seus tokens. A [SideSwap](https://sideswap.io/) é a mais recomendada e funciona no celular.
3. **Um e-mail** — é tudo o que o DePix App pede para cadastro. Não precisa de documentos, selfie ou KYC.

Essa simplicidade é proposital. O DePix App foi projetado para que qualquer pessoa consiga comprar stablecoin com Pix sem precisar de uma corretora tradicional.

## Passo a passo: como comprar DePix com Pix

Siga estes passos para fazer sua primeira compra:

### 1. Crie sua conta no DePix App

Acesse [depixapp.com](https://depixapp.com/) e faça seu cadastro usando apenas um e-mail. Você pode escolher entre o modo **pessoa física** ou **lojista/autônomo**, dependendo do seu uso.

### 2. Configure sua carteira Liquid

Se ainda não tem uma carteira Liquid, baixe a [SideSwap](https://sideswap.io/) no seu celular. Anote o endereço Liquid da sua carteira — é para lá que seus DePix serão enviados. Guarde bem suas palavras de recuperação (seed phrase). Quem controla a seed, controla o dinheiro.
...
O app gera um QR code Pix. Abra o aplicativo do seu banco, escaneie o código e confirme o pagamento. É o mesmo processo que você já usa para pagar qualquer boleto ou compra com Pix.
...
Quando o processamento terminar, abra sua carteira SideSwap e confira o saldo de DePix. Pronto — seus reais agora estão na Liquid Network, sob seu controle total.

{{< diagram alt="Passo a passo para comprar DePix: cadastro no app, configuração da carteira Liquid, pagamento Pix e recebimento dos tokens" caption="Do cadastro ao recebimento: o processo completo para comprar DePix com Pix." >}}
<div class="d-flow-row">
  <div class="d-step dark">Cadastro no DePix App</div>
  <div class="d-arrow">e-mail</div>
  <div class="d-step dark">Informa valor + endereço Liquid</div>
  <div class="d-arrow">gera QR</div>
  <div class="d-step accent">Paga Pix no banco</div>
  <div class="d-arrow">até 24h</div>
  <div class="d-step warn">Verificação anti-fraude</div>
  <div class="d-arrow">tokens</div>
  <div class="d-step success">DePix na carteira</div>
</div>
{{< /diagram >}}
...
| Valor depositado | Taxa (2% + R$ 0,99) | DePix recebido |
|---|---|---|
| R$ 50 | R$ 1,99 | R$ 48,01 |
...
## DePix é confiável? É seguro?

Essa é a pergunta mais comum de quem começa, e ela faz todo sentido. Aqui estão os pontos que garantem a segurança:
...
**Preciso de documentos para comprar DePix?**
Não. O cadastro exige apenas um e-mail. Sem selfie, sem comprovante de renda, sem KYC.

**Qual o valor mínimo?**
R$ 5,00.

**Qual o valor máximo por dia?**
R$ 6.000 por CPF.

**Por que demora até 24 horas?**
Segurança. O prazo permite verificar se o Pix não veio de um golpe antes de liberar os tokens.

**Posso usar qualquer banco?**
Sim. Qualquer banco ou fintech com Pix funciona.
...
Pix tem praticidade — DePix tem privacidade. Agora que você sabe como comprar, o próximo passo é seu. Pare de expor cada transação ao sistema bancário e comece a usar dinheiro digital que só você controla. Acesse [depixapp.com](https://depixapp.com/).
