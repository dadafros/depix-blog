...
image: "/images/posts/declarar-depix-imposto-renda/declarar-depix-imposto-renda-16x9.png"
images:
  - "/images/posts/declarar-depix-imposto-renda/declarar-depix-imposto-renda-1x1.png"
  - "/images/posts/declarar-depix-imposto-renda/declarar-depix-imposto-renda-4x3.png"
  - "/images/posts/declarar-depix-imposto-renda/declarar-depix-imposto-renda-16x9.png"
draft: false
---
...
## Onde declarar DePix no programa do IRPF

O DePix é classificado como **stablecoin** pela Receita Federal. Veja como preencher:
...
Se você também tem outros criptoativos, use os códigos corretos:

| Código | Tipo de criptoativo | Exemplos |
|---|---|---|
| 01 | Bitcoin | BTC |
| 02 | Outras criptomoedas (altcoins) | ETH, SOL, ADA, XRP |
| 03 | Stablecoins | DePix, USDT, USDC, BRZ |
| 10 | NFTs | Tokens não-fungíveis |
| 99 | Outros criptoativos | Tokens utilitários, DeFi |
...
{{< diagram alt="Onde declarar DePix no IRPF: Ficha Bens e Direitos, Grupo 08 Criptoativos, Código 03 Stablecoins" caption="Caminho para declarar DePix no programa do IRPF 2026." >}}
<div class="d-flow-row">
  <div class="d-step dark">Bens e Direitos</div>
  <div class="d-arrow">→</div>
  <div class="d-step accent">Grupo 08: Criptoativos</div>
  <div class="d-arrow">→</div>
  <div class="d-step success">Código 03: Stablecoins</div>
</div>
{{< /diagram >}}

## Ganho de capital: quando você paga imposto

Possuir DePix não gera imposto. O imposto incide apenas sobre o **ganho de capital** — ou seja, quando você vende ou troca um criptoativo por um valor maior do que pagou.
...
### Cenários comuns com DePix

| Operação | Gera imposto? |
|---|---|
...
- **Alinhamento com o CARF** (Crypto-Asset Reporting Framework) da OCDE — padrão internacional de reporte.
- **Escopo ampliado**: além de compra/venda/troca/doação, agora inclui staking, mineração, airdrops e empréstimos com cripto como garantia.
- **Não altera as regras tributárias** (alíquotas, isenções, etc.) — muda apenas a forma como os dados são reportados.

Até 30 de junho de 2026, o modelo antigo (IN 1888) permanece em vigor. A transição é gradual, mas fique atento ao novo prazo.
...
## Checklist da declaração de DePix
...
Este guia cobre o cenário mais comum: comprar DePix, guardar e eventualmente trocar ou vender. Para a maioria dos usuários, o processo é simples e pode ser feito por conta própria no programa do IRPF.
...
Declarar é uma obrigação legal — mas a privacidade é um direito fundamental inviolável, garantido pela Constituição Federal do Brasil. Com DePix, suas transações na Liquid Network usam Confidential Transactions, garantindo seus direitos. Cumpra suas obrigações fiscais sem abrir mão da sua privacidade — esse é o melhor dos dois mundos. Acesse [depixapp.com](https://depixapp.com/) e retome a soberania sobre seus dados financeiros.
